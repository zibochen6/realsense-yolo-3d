#!/usr/bin/env python3
"""
RealSense YOLO-3D with Real Depth and Simple 3D Bounding Boxes
Simplified version that works around the BEV issue
"""
...
class RealSenseSimple3D:
    """
    RealSense camera with real depth support and simple 3D bounding boxes
    """
...
def main():
    print("=== RealSense YOLO-3D with Real Depth and Simple 3D Boxes ===")
